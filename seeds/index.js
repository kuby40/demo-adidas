...
const createClothing = () => {
    const obj = {
      name: "Basic Hoodie",
      description: {
        title: "The most Comfy Hoodie!",
        explanation: "Made of cotton this hoodie will make you feel pure bliss",
      },
      ...
      picture: "Replace This String With the Photo Link On Cloudinary",
      price: 40.0,
