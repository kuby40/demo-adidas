      ...
      <div>
        <div className="bg-yellow-100 p-6">
          ...
          <p className="my-3">
            ...
            performance. Beat your PB. Fake offers a home to the runner, the
          ...
          <p>
            Fake designs for and with athletes of all kinds. Creators, who love
            to change the game. Challenge conventions. Break the rules and
            ...
            iterate. Testing new technologies in action. On the pitch, the
            tracks, the court, the pool. Retro workout clothes inspire new
            street-wear essentials. Like NMD, Ozweego and our Firebird
          ...
          <p className="my-3">
            ...
            high performance. Like our Fake by Stella McCartney athletic
            clothing collection – designed to look the part inside and outside
            of the gym. Or some of our Fake Originals lifestyle pieces, that can
            be worn as sportswear too. Our lives are constantly changing.
            Becoming more and more versatile. And Fake designs with that in
            mind.
          </p>
        </div>
